...
scoreboard players set temp_0 mech_data 900
...
execute if score temp_1 mech_data = con_2 mech_data run scoreboard players operation out_0 mech_data *= con_-1 mech_data
