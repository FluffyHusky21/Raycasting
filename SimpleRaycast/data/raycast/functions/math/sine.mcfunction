...
# out_0: result
#calculates sine to 3 decimal places (stored as integer)
...
scoreboard players set temp_0 ray_data 180
scoreboard players operation temp_0 ray_data -= in_0 ray_data

scoreboard players set out_0 ray_data 4000
scoreboard players operation out_0 ray_data *= temp_0 ray_data
scoreboard players operation out_0 ray_data *= in_0 ray_data

scoreboard players set temp_1 ray_data 40500
scoreboard players operation temp_0 ray_data *= in_0 ray_data
